...
First, we introduce a microstructure-based framework that decomposes price pressure into information-driven and liquidity-driven components using economically interpretable features derived from high-frequency data.
Second, we provide statistical validation of this decomposition by applying principal component analysis to the feature space, demonstrating that the data naturally organizes into latent structures consistent with the proposed economic mechanisms.
Third, we show that these measures have predictive content for post-earnings returns, linking intraday trading behavior to well-documented anomalies such as post-earnings announcement drift.
Together, these contributions bridge market microstructure theory and empirical asset pricing, providing a unified framework for understanding the role of trading dynamics in price formation.
