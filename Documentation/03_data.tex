...
\mathrm{OFI\_abs\_mean}_i &\equiv \mathrm{mean}_{d\in\mathcal{D}_i^{-}}\!\left(|\mathrm{OFI}_{j(i),d}|\right), \\
\mathrm{OFI\_std\_mean}_i &\equiv \mathrm{mean}_{d\in\mathcal{D}_i^{-}}\!\left(\mathrm{OFIstd}_{j(i),d}\right), \\
\mathrm{SpreadStab\_mean}_i &\equiv \mathrm{mean}_{d\in\mathcal{D}_i^{-}}\!\left(\mathrm{SpreadStab}_{j(i),d}\right), \\
\mathrm{SpreadStd\_mean}_i &\equiv \mathrm{mean}_{d\in\mathcal{D}_i^{-}}\!\left(\mathrm{SpreadStd}_{j(i),d}\right), \\
\mathrm{SpreadP95\_max}_i &\equiv \max_{d\in\mathcal{D}_i^{-}}\!\left(\mathrm{SpreadP95}_{j(i),d}\right), \\
\mathrm{MorningShare\_mean}_i &\equiv \mathrm{mean}_{d\in\mathcal{D}_i^{-}}\!\left(\mathrm{MorningShare}_{j(i),d}\right), \\
\mathrm{VolumeBurstFrac}_i &\equiv \frac{1}{N_i}\sum_{d\in\mathcal{D}_i^{-}} \mathbf{1}\!\left[\mathrm{AbnVol}_{j(i),d}>1.5\right].
\end{aligned}
\end{equation}
...
\hline
$i$ & Earnings announcement (event) index; event date $\mathrm{rdq}_i$ 
\newline (Compustat $\texttt{fundq.rdq}$) \\
