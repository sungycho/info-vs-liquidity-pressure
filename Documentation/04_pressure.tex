...
While the above construction is economically motivated, it remains an open empirical question whether the data itself supports such a decomposition. To address this, we next examine the latent structure of the feature space using principal component analysis. Since the pressure classification framework is constructed from economically motivated microstructure features, these variables are inherently high-dimensional and potentially collinear. To address this, we complement the structural approach with a statistical dimensionality reduction using Principal Component Analysis (PCA).
