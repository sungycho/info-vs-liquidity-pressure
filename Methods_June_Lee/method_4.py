# Method 4: Separate PI and RI. Use Principal Component Analysis to verify which components are the most meaningful. Then, group components or weigh accordingly.
import numpy as np
import pandas as pd
